...
alter table if exists quiz_question
    drop constraint if exists FKakqyu5s2n32ycpvhkh9sx7m35;
...
alter table if exists user_profile_friends
    drop constraint if exists FK5lb28kivsykk6e7nl1oyom6uf;

alter table if exists user_profile_friends
    drop constraint if exists FKjucexl0egjmb7g5fvjm9d7f9d;
