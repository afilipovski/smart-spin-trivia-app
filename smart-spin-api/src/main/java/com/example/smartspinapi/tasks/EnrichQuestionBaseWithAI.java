...
public class EnrichQuestionBaseWithAI implements CommandLineRunner {
    ...
    public synchronized void run(String... args) {
        ...
        for (var category : categoryList) {
            ...
            systemMessage.content = "You are a helpful assistant. Have a laconic way of answering - only output what is asked, no niceties.";
            ...
            userMessage.content = "Generate 20 trivia questions on the topic of " + category.name + ". " +
                    ...
                    "Make sure not to output anything other than the 20 lines with the aforementioned format." +
        ...
        System.out.println("Finished generating questions with LLM");
    }
}
